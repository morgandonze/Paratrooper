#!/usr/bin/env python3
"""
Task management business logic for the Paratrooper system.

This module contains the TaskManager class which handles all task operations,
file parsing, synchronization, and business logic.
"""
...
from models import (
    ...
    TASK_STATUS, FORBIDDEN_TASK_CHARS
)
